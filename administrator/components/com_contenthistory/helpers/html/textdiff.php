...
abstract class JHtmlTextdiff
{
	...
	public static function textdiff($containerId)
	{
		...
		$document->addScript('components/com_contenthistory/media/js/diff_match_patch.js', 'text/javascript', true);
		$document->addScript('components/com_contenthistory/media/js/jquery.pretty-text-diff.min.js', 'text/javascript', true);
